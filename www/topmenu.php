...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img style="max-width:25px;max-height:25px;" src="images/Cart-512.jpg" alt="Brand"></img>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      ?>
        <li><a class="navbar-brand" href="cart.php"><img style="max-width:25px;max-height:25px;" src="images/images.jpg" alt="Brand"></img>
